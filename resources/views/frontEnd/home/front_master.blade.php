            ...
            <div class="container box-1420">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item {{Request::path() == 'enrolment'? 'active':''}}"><a class="nav-link"
                                                                                              href="{{url('/')}}/enrolment">Enrolment</a>
                        </li>
                        <li class="nav-item">
...
<script src="{{asset('public/build/js/intlTelInput-jquery.min.js')}}"></script>
