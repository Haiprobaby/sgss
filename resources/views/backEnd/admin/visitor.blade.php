    ...
    <section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.manage') @lang('lang.visitor_book')</h1>
                <div class="bc-pages">
                                            ...
                                            <div class="input-effect">
                                                @isset($visitor)
                                                    <textarea class="primary-input form-control" cols="0" rows="4"
                                                              name="description">{{ @$visitor->description}}</textarea>
                                                @else
                                                    <textarea class="primary-input form-control" cols="0" rows="4"
                        ...
                        <div class="col-lg-12">
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                @foreach($visitors as $visitor)
                                    <tr @if($visitor->read==0)style="background-color: #F9E9E5;"@endif >
                                        <td>{{$count++}}</td>
                                        <td>{{ @$visitor->name}}</td>
                                        ...
                                        <td>@if($visitor->read==1) Read @else Unread @endif   </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a id="{{$visitor->id}}" class="dropdown-item modalLink" title="Visit Details"
                                                       data-modal-size="large-modal"
                                                       href="{{url('visit', [@$visitor->id])}}" onclick="markasread({{$visitor->id}})">@lang('lang.view')</a>
                                                    @endif
