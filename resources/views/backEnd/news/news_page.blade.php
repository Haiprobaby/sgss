                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30">@if(!empty($add_news))
                                    @lang('lang.update')
                                @else
                                    @lang('lang.add')
                                @endif
                            ...
                            <div class="add-visitor">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{!empty($add_news)? $add_news->news_title: old('title')}}">
                                                    <input type="hidden" name="id" value="{{!empty($add_news)? $add_news->id: ''}}">
                                                    <br>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <select 
                                                    id="category"
                                                    class=" form-control{{ $errors->has('accounts') ? ' is-invalid' : '' }}"
                                                    name="category_id"  >
                                                    <option data-display="@lang('lang.category') *" value="">@lang('lang.select') *</option>
                                                    @foreach($news_category as $value)
                                                    <option data-display="{{$value->category_name}}" value="{{$value->id}}"
                                                        @if(!empty($add_news))
                                                            @if($add_news->category->id 
                                                                == 
                                                                $value->id)
                                                                selected
                                                            @endif
                                        ...
                                        <div class="row no-gutters input-right-icon mt-20">
                                            <div class="col-lg-12">
                                                ...
                                                <select 
                                                    id="subcategory" 
                                                    class="subcategory  form-control{{ $errors->has('accounts') ? ' is-invalid' : '' }} "
                                                    name="sub_category_id" 
                                                >
                                                    <option data-display="@lang('sub category') *" value="">@lang('lang.select') *</option>
                                                    @foreach($news_sub_category as $value)
                                                    <option data-display="{{$value->sub_category_name}}" value="{{$value->id}}"
                                                        @if(!empty($add_news))
                                                            @if($add_news->sub_category_id == $value->id)
                                                                selected
                                                            @endif
                                                        @endif>
                                       ...
                                       <div class="row no-gutters input-right-icon mt-20">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input
                                                        ...
                                                        name="date"
                                                        value="{{!empty($add_news)? date('m/d/Y', strtotime($add_news->publish_date)): date('m/d/Y')}}">
                                                    <span class="focus-border"></span>
                                                    @if ($errors->has('date'))
                                                        <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            <input class="primary-input" type="text" id="placeholderFileOneName"
                                                                   placeholder="{{!empty($add_news)? ($add_news->image !="") ? showPicName($add_news->image) :'image' :'image' }}"
                                                                   readonly
                                                            >
                                                            <span class="focus-border"></span>
                                                        </div>
                                        ...
                                        <div class="row mt-25">
                                            ...
                                            <textarea class="primary-input form-control" cols="0" rows="4" id="a" 
                                                      name="description">{{!empty($add_news)? $add_news->description: old('news_body')}}</textarea>
                                ...
                                <div class="row mt-25">
                                            ...
                                            <textarea class="primary-input form-control" cols="0" rows="4" id="summernote" 
                                                      name="news_body">{{!empty($add_news)? $add_news->news_body: old('news_body')}}</textarea>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            @foreach($news as $value)
                                <tr>
                                    ...
                                    <td>{{$value->sub_category_id !=""?$value->subcategory->sub_category_name:""}}</td>
