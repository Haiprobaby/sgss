...
class SmAddIncomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $add_incomes = SmAddIncome::where('active_status', '=', 1)->orderBy('id','desc')->get();
    ...
    public function edit(Request $request, $id)
    {
        ...
        try {
            ...
            return view('backEnd.accounts.add_income', compact('add_income', 'add_incomes', 'income_heads', 'bank_accounts', 'payment_methods','student_list'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
