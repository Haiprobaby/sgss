...
class SmStudentAdmissionController extends Controller
{
    ...
    public function admission()
    {
        ...
        try {
            ...
            if(SmGeneralSettings::isModule('SaasSubscription')== TRUE && SmGeneralSettings::isModule('Saas') == TRUE){
    ...
    {
        try {
            $sectionIds = SmClassSection::where('class_id', '=', $request->id)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function studentDetails(Request $request)
    {
        try {
            ...
            $student_list = DB::table('sm_students')
                ...
                ->where('sm_students.academic_id', YearCheck::getAcademicId())
    ...
    public function studentView(Request $request, $id)
    {
        ...
        try {
            ...
            $grades = SmMarksGrade::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            ...
            $exam_terms = SmExamType::where('school_id', Auth::user()->school_id)->where('academic_id', YearCheck::getAcademicId())->get();
    ...
    public function uploadDocument(Request $request)
    {
        try {
            if ($request->file('photo') != "" && $request->title != "") {
                ...
                $document->academic_id = YearCheck::getAcademicId();
                $document->save();
            }
    ...
    public function studentTimelineStore(Request $request)
    {
        try {
            if ($request->title != "") {
                ...
                $timeline->academic_id = YearCheck::getAcademicId();
                $timeline->save();
            }
            Toastr::success('Operation successful', 'Success');
            return redirect()->back();
    ...
    public function studentEdit(Request $request, $id)
    {
        try {
            ...
            return view('backEnd.studentInformation.student_edit', compact('student', 'classes', 'religions', 'blood_groups', 'genders', 'route_lists', 'vehicles', 'dormitory_lists', 'categories', 'sessions', 'siblings', 'driver_lists'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function studentPromote(Request $request)
    {
        try {
            ...
            $exams = SmExamType::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    {
        $students = SmStudent::where('class_id', '=', $request->class)->where('section_id', $request->section)->where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
        ...
        try {
            if ($request->result == 'P') {
                ...
                foreach ($students['allresult_data'] as $key => $value) {
                    $d = SmStudent::where('id', $value->student_id)->where('academic_id', YearCheck::getAcademicId())->first();
                ...
                $students = SmStudent::where('class_id', '=', $request->current_class)->where('session_id', '=', $request->current_session)->where('section_id', $request->section)->where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            }
            $current_session = $request->current_session;
            $current_class = $request->current_class;
            $sessions = SmAcademicYear::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function studentPromoteStore(Request $request)
    {
        ...
        try {
            ...
            if ($request->promote_class == "" || $request->promote_session == "") {
                $students = SmStudent::where('class_id', '=', $request->promote_class)->where('session_id', '=', $request->promote_session)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
                //dd($students);
                ...
                try {
                    ...
                    foreach ($request->id as $student_id) {
                        ...
                        if ($request->result[$student_id] == 'P') {
                            $merit_list = \App\SmTemporaryMeritlist::where(['student_id' => $student_id, 'class_id' => $request->current_class, 'section_id' => $student_details->section_id])->where('academic_id', YearCheck::getAcademicId())->first();
                    ...
                    DB::rollback();
                    $students = SmStudent::where('class_id', '=', $request->current_class)->where('session_id', '=', $request->current_session)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function studentReportSearch(Request $request)
    {
        ...
        try {
            ...
            $students->where('academic_id', YearCheck::getAcademicId())->where('active_status', 1);
    ...
    public function studentAttendanceReportSearch(Request $request)
    {
        ...
        try {
            ...
            foreach ($students as $student) {
                $attendance = SmStudentAttendance::where('student_id', $student->id)->where('attendance_date', 'like', $request->year . '-' . $request->month . '%')->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        if(SmGeneralSettings::isModule('SaasSubscription')== TRUE){
                            ...
                            if(\Modules\SaasSubscription\Entities\SmPackagePlan::student_limit() <= $active_student){
                                ...
                                Toastr::error('Your student limit has been crossed. Your last admitted student name '.$student->full_name.'.', 'Failed');
                                return redirect('student-list');
    ...
    {
        try {
            $students = SmStudent::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $classes = SmClass::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    {
        try {
            $students = SmStudent::where('active_status', 0)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function disabledStudentSearch(Request $request)
    {
        ...
        try {
            $students = SmStudent::query();
            $students->where('academic_id', YearCheck::getAcademicId())->where('active_status', 0);
            if ($request->class != "") {
                $students->where('class_id', $request->class);
            }
            if ($request->section != "") {
    ...
    public function studentHistory(Request $request)
    {
        try {
            $classes = SmClass::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $students = SmStudent::where('active_status', 1)->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();
            $admission_years = SmStudent::groupBy('admission_date')->select('admission_date')->where('academic_id', YearCheck::getAcademicId())->where('school_id', Auth::user()->school_id)->get();

            $years = SmStudent::select('admission_date')->where('active_status', 1)
                ->where('academic_id', YearCheck::getAcademicId())->get()
