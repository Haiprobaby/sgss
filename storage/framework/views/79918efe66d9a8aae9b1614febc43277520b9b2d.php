    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            <?php if(isset($visitor)): ?>
                <?php if(in_array(487, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12">
                                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('style') ? ' is-invalid' : ''); ?>" name="style" id="style">
                                                ...
                                                <option value="1"><?php echo app('translator')->get('lang.dashboard'); ?> <?php echo app('translator')->get('lang.background'); ?></option>
                                                <option value="2"><?php echo app('translator')->get('lang.login'); ?> <?php echo app('translator')->get('lang.page'); ?> <?php echo app('translator')->get('lang.background'); ?></option>
                                            </select>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12"> 
                                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('background_type') ? ' is-invalid' : ''); ?>" name="background_type" id="background-type">
                                                ...
                                                <option value="color"><?php echo app('translator')->get('lang.color'); ?></option>
                                                <option value="image"><?php echo app('translator')->get('lang.image'); ?> (1920x1400)</option>
                                            </select>
                                    ...
                                    <?php 
                                        $tooltip = "";
                                        if(in_array(487, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ){
                                                $tooltip = "";
                                            }else{
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if(@$background_setting->is_default==1): ?> 
                                                <a  class="primary-btn small fix-gr-bg " href="<?php echo e(url('/background_setting-status')); ?>/<?php echo e(@$background_setting->id); ?>"> <?php echo app('translator')->get('lang.activated'); ?> </a> 
                                            <?php else: ?>
                                            <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> 
                                                <?php if(in_array(489, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                <a  class="primary-btn small tr-bg" href="#"> <?php echo app('translator')->get('lang.make'); ?> <?php echo app('translator')->get('lang.default'); ?></a> 
                                                </span>
                                                <?php endif; ?>
                                            <?php else: ?>
                                            <?php if(in_array(489, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            <a  class="primary-btn small tr-bg" href="<?php echo e(url('/background_setting-status')); ?>/<?php echo e(@$background_setting->id); ?>"> <?php echo app('translator')->get('lang.make'); ?> <?php echo app('translator')->get('lang.default'); ?></a> 
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if(in_array(488, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\SGSS\resources\views/backEnd/systemSettings/background_setting.blade.php ENDPATH**/ ?>