    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="col-lg-2 pull-right text-right">
                <a href="<?php echo e(url('add-notice')); ?>" class="primary-btn small fix-gr-bg"> <span class="ti-plus pr-2"></span> <?php echo app('translator')->get('lang.add'); ?> </a>
            </div>
                        ...
                        foreach ($notices as $notice) {
                            ...
                            if (in_array($role_id, $inform_to)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(url('view/notice/'.@$notice->id)); ?>" title="View notice"  class="primary-btn small tr-bg modalLink" data-modal-size="modal-lg"><?php echo app('translator')->get('lang.view'); ?></a>
                                    </td>
                                </tr>
                                <?php
                            }
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\sgss\t\sgss\resources\views/backEnd/dashboard.blade.php ENDPATH**/ ?>