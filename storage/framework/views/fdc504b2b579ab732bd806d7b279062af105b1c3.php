...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        <?php if(isset($leave_define)): ?>
         <?php if(in_array(200, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
               
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                <a href="<?php echo e(url('leave-define')); ?>" class="primary-btn small fix-gr-bg">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <?php if(isset($leave_define)): ?>
                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'leave-define/'.$leave_define->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>

                <?php else: ?>
                 <?php if(in_array(200, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'leave-define',
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <?php if(in_array(201, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>

                                            <a class="dropdown-item" href="<?php echo e(url('leave-define', [$leave_define->id
                                                ])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                <?php endif; ?>
                                                <?php if(in_array(202, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        <?php echo e(Form::open(['url' => 'leave-define/'.$leave_define->id, 'method' => 'DELETE', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\www\SGSS\resources\views/backEnd/humanResource/leave_define.blade.php ENDPATH**/ ?>