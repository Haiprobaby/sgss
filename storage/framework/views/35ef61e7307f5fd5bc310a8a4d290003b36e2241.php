                            ...
                            <div class="main-title">
                                <h3 class="mb-30"><?php if(isset($complaint)): ?>
                                    ...
                                    <?php else: ?>
                                        <?php echo app('translator')->get('lang.add'); ?>
                                    <?php endif; ?>
                                    <?php echo app('translator')->get('lang.complaint'); ?>
                                </h3>
                            </div>
                            <?php if(isset($complaint)): ?>
                                    ...
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('lang.complaint'); ?> <?php echo app('translator')->get('lang.by'); ?><span>*</span></label>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <select
                                                ...
                                                name="complaint_type">
                                                <option data-display="<?php echo app('translator')->get('lang.complaint'); ?> <?php echo app('translator')->get('lang.type'); ?>*" value=""><?php echo app('translator')->get('lang.type'); ?> *</option>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <select
                                                ...
                                                <option data-display="<?php echo app('translator')->get('lang.complaint'); ?> <?php echo app('translator')->get('lang.source'); ?> *" value=""><?php echo app('translator')->get('lang.complaint'); ?> <?php echo app('translator')->get('lang.source'); ?> *
                                                </option>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('lang.actions'); ?> <?php echo app('translator')->get('lang.taken'); ?></label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('lang.assigned'); ?></label>
                                                <span class="focus-border"></span>
                                ...
                                ?>
                                    <div class="row mt-40">
                                        <div class="col-lg-12 text-center">
                                           <button class="primary-btn fix-gr-bg now_wrap_lg" data-toggle="tooltip" title="<?php echo e($tooltip); ?>">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item modalLink" title="Complaint Details"
                                                       ...
                                                       href="<?php echo e(url('complaint', [@$complaint->id])); ?>"><?php echo app('translator')->get('lang.view'); ?></a>
                                                    <?php endif; ?>
                                                       <?php if(in_array(23, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1): ?>

                                                       <a class="dropdown-item"
                                                       href="<?php echo e(url('complaint/'.@$complaint->id.'/edit')); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                   <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\www\SGSS\resources\views/backEnd/admin/complaint.blade.php ENDPATH**/ ?>