                                        ...
                                        <td>
                                            ...
                                            <?php if($background_setting->is_active==1): ?>
                                                <a class="primary-btn small fix-gr-bg "
                                                   href="#">  Activated </a>
                                            <?php else: ?>
                                            <?php if(in_array(491, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\SGSS\resources\views/backEnd/systemSettings/color_theme.blade.php ENDPATH**/ ?>