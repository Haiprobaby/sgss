...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-9">
            ...
            <h6 ><?php echo app('translator')->get('lang.category'); ?>: <?php echo e($news->category->category_name); ?></h6>
...
<?php /**PATH C:\wamp64\www\SGSS\resources\views/backEnd/news/news_details.blade.php ENDPATH**/ ?>