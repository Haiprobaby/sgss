...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        <?php if(isset($base_setup)): ?>
            <?php if(in_array(429, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
            <div class="row">
                <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                    <a href="<?php echo e(url('base_setup')); ?>" class="primary-btn small fix-gr-bg">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <?php 
                                  $tooltip = "";
                                  if(in_array(429, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ){
                                        $tooltip = "";
                                    }else{
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <?php if(in_array(430, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                                                            <a class="dropdown-item" href="<?php echo e(route('base_setup_edit', [@$base_setup->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                                        <?php endif; ?>
                                                                        <?php if(in_array(431, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\SGSS\resources\views/backEnd/systemSettings/baseSetup/base_setup.blade.php ENDPATH**/ ?>