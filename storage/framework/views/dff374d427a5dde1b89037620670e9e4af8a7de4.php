...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
                ...
                <?php else: ?>
                <h1><?php echo app('translator')->get('lang.approve_leave_request'); ?><h1>
                <?php endif; ?>
            <div class="bc-pages">
            ...
            <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                            ...
                            <?php if($pending): ?>
                            <h3><?php echo app('translator')->get('lang.pending_leave_request'); ?><h3>
                            <?php else: ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a data-modal-size="modal-lg" title="View/Edit Leave Details" class="dropdown-item modalLink" href="<?php echo e(url('view-leave-details-approve', $apply_leave->id)); ?>"><?php echo app('translator')->get('lang.view'); ?>/<?php echo app('translator')->get('lang.approved'); ?></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\www\SGSS\resources\views/backEnd/humanResource/approveLeaveRequest.blade.php ENDPATH**/ ?>