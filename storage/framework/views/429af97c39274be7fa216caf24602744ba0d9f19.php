...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.manage'); ?> <?php echo app('translator')->get('lang.admission_query'); ?></h1>
            <div class="bc-pages">
...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
            ...
            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'admission-query-search', 'method' => 'POST', 'enctype' => 'multipart/form-data','id'=>'infix_form'])); ?>
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <input name="date_from" readonly class="primary-input date <?php echo e($errors->has('date_from') ? ' is-invalid' : ''); ?>" type="text" autocomplete="off" value="<?php echo e(isset($date_from)? ($date_from != ""? $date_from:''):''); ?>">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <input name="date_to" readonly class="primary-input date <?php echo e($errors->has('date_to') ? ' is-invalid' : ''); ?>" type="text" autocomplete="off" value="<?php echo e(isset($date_to)? ($date_to != ""? $date_to:''):''); ?>">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <select name="source" class="niceSelect w-100 bb form-control <?php echo e($errors->has('select_source') ? ' is-invalid' : ''); ?>" required>
                                            <option data-display="<?php echo app('translator')->get('lang.select_source'); ?> *" value=""><?php echo app('translator')->get('lang.select_source'); ?> *</option>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                         <select class="niceSelect w-100 bb form-control <?php echo e($errors->has('select_status') ? ' is-invalid' : ''); ?>" name="status">
                                            <option data-display="<?php echo app('translator')->get('lang.select_status'); ?> *" value=""><?php echo app('translator')->get('lang.Status'); ?> *</option>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td  data-sort="<?php echo e(strtotime(@$admission_query->date)); ?>" ><?php echo e(App\SmGeneralSettings::DateConvater(@$admission_query->date)); ?> </td>
                                        <td  data-sort="<?php echo e(strtotime(@$admission_query->last_follow_up_date)); ?>" >
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if(in_array(13, $module_links) || Auth::user()->role_id == 1): ?>
                                                       <a class="dropdown-item" href="<?php echo e(route('add_query', [@$admission_query->id])); ?>"><?php echo app('translator')->get('lang.add_query'); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(in_array(14, $module_links) || Auth::user()->role_id == 1): ?>
                                                     <a class="dropdown-item modalLink" data-modal-size="large-modal" title="<?php echo app('translator')->get('lang.edit'); ?> <?php echo app('translator')->get('lang.admission_query'); ?>"  href="<?php echo e(route('admission_query_edit', [@$admission_query->id])); ?>" ><?php echo app('translator')->get('lang.edit'); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(in_array(15, $module_links) || Auth::user()->role_id == 1): ?>
                                                     <a class="dropdown-item deleteAdmissionQueryModal" href="#" data-toggle="modal" data-target="#deleteAdmissionQueryModal" data-id="<?php echo e(@$admission_query->id); ?>"><?php echo app('translator')->get('lang.delete'); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-effect">
                                            <input class="primary-input read-only-input form-control" type="text" name="phone" id="phone" onkeypress="return isNumberKey(event)">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-effect">
                                            <input class="primary-input read-only-input form-control" type="email" name="email">
                            ...
                            <div class="col-lg-12 mt-25">
                                <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input date form-control" id="startDate" type="text"
                                                        name="date" readonly="true" value="<?php echo e(date('m/d/Y')); ?>" required>
                                            ...
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input date form-control" id="endDate" type="text"
                                                         name="next_follow_up_date" autocomplete="off" readonly="true" value="<?php echo e(date('m/d/Y')); ?>" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-effect">
                                            <input class="primary-input read-only-input form-control" type="text" name="assigned" id="assigned">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <select class="niceSelect w-100 bb" name="reference" id="reference">
                                            <option data-display="<?php echo app('translator')->get('lang.reference'); ?> *" value=""><?php echo app('translator')->get('lang.reference'); ?> *</option>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect">
                                            <input class="primary-input read-only-input form-control" onkeypress="return isNumberKey(event)"
                                            type="number" min="1" name="no_of_child" id="no_of_child">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\www\SGSS\resources\views/backEnd/admin/admission_query.blade.php ENDPATH**/ ?>