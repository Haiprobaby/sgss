    ...
    <div class="col-md-6 offset-3  mt-40">
        ...
        <div class="card">
            ...
            <div class="card-body">
                  ...
                  <p style="padding-left: 15px; font-weight: bold;">Your System Admin Email : <?php echo e(Session::get('system_admin_email')); ?></p>
                  <p style="padding-left: 15px; font-weight: bold;">Your System Password : <?php echo e(Session::get('system_admin_password')); ?></p>

               <a href="<?php echo e(url('/login')); ?>"  class="offset-3 col-sm-6 primary-btn fix-gr-bg mt-40 mb-20"  >  Login </a>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\SERVER\www\SGSS\resources\views/install/confirmation.blade.php ENDPATH**/ ?>