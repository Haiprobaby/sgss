...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.transport_route'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.transport'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.transport_route'); ?></a>
            </div>
        </div>
    </div>
</section>
                                    ...
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="title" autocomplete="off" value="<?php echo e(isset($route)? @$route->title:old('title')); ?>">
                                            <input type="hidden" name="id" value="<?php echo e(isset($route)? @$route->id: ''); ?>">
                                            <label><?php echo app('translator')->get('lang.route_title'); ?> <span>*</span></label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('far') ? ' is-invalid' : ''); ?>"
                                                type="number" step="any" name="far" autocomplete="off" value="<?php echo e(isset($route)? @$route->far:old('far')); ?>">
                                            <label><?php echo app('translator')->get('lang.fare'); ?> <span>*</span></label>
                                            <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">  <?php echo app('translator')->get('lang.route'); ?>  <?php echo app('translator')->get('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th> <?php echo app('translator')->get('lang.fare'); ?> (<?php echo e(@$currency); ?>)</th>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               <?php if(in_array(351, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1  ): ?>
                                                <a class="dropdown-item" href="<?php echo e(url('transport-route', [@$route->id])); ?>"> <?php echo app('translator')->get('lang.edit'); ?></a>
                                               <?php endif; ?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"> <?php echo app('translator')->get('lang.delete'); ?>  <?php echo app('translator')->get('lang.route'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\SGSS\resources\views/backEnd/transport/route.blade.php ENDPATH**/ ?>