	...
	<div class="col-sm-10">
		<table class="table">
		  ...
		  <tbody>
		    ...
		    <tr class="d-flex">
		      <td class="col-sm-1"><?php echo e($years->title); ?></td>
		      <input type="hidden" name="year_id[]" value="<?php echo e($years->id); ?>">
		      <td class="col-sm-2"><input type="text" class="form-control" name="paymentA[]" value="<?php echo e(number_format($years->tuition_payment_A)); ?>"></td>
		      	<td class="col-sm-1"></td>
		      <td class="col-sm-2"><input type="text" class="form-control" name="paymentB1[]" value="<?php echo e(number_format($years->tuition_payment_B1)); ?>"></td>
		      <td class="col-sm-2"><input type="text" class="form-control" name="paymentB2[]" value="<?php echo e(number_format($years->tuition_payment_B2)); ?>"></td>
		      <td class="col-sm-2"><input type="text" class="form-control" name="paymentB3[]" value="<?php echo e(number_format($years->tuition_payment_B3)); ?>"></td>
		    </tr>
		    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		  </tbody>
		</table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\SGSS\resources\views/backEnd/feesCollection/fee_policies/edit.blade.php ENDPATH**/ ?>