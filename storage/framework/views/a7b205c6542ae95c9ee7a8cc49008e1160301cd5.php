    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('lang.add_news'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('lang.news'); ?></a>
                    <a href="#"><?php echo app('translator')->get('lang.add_news'); ?></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(!empty($add_news)): ?>
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                                    ...
                                                    <input
                                                        ...
                                                        value="<?php echo e(!empty($add_news)? $add_news->news_title: old('title')); ?>">
                                                    <input type="hidden" name="id" value="<?php echo e(!empty($add_news)? $add_news->id: ''); ?>">
                                                    <br>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <select 
                                                    id="category"
                                                    class=" form-control<?php echo e($errors->has('accounts') ? ' is-invalid' : ''); ?>"
                                                    name="category_id"  >
                                                    <option data-display="<?php echo app('translator')->get('lang.category'); ?> *" value=""><?php echo app('translator')->get('lang.select'); ?> *</option>
                                        ...
                                        <div class="row no-gutters input-right-icon mt-20">
                                            <div class="col-lg-12">
                                                ...
                                                <select 
                                                    id="subcategory" 
                                                    class="subcategory  form-control<?php echo e($errors->has('accounts') ? ' is-invalid' : ''); ?> "
                                                    name="sub_category_id" 
                                                >
                                                    <option data-display="<?php echo app('translator')->get('sub category'); ?> *" value=""><?php echo app('translator')->get('lang.select'); ?> *</option>
                                                    <?php $__currentLoopData = $news_sub_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option data-display="<?php echo e($value->sub_category_name); ?>" value="<?php echo e($value->id); ?>"
                                                        <?php if(!empty($add_news)): ?>
                                                            <?php if($add_news->sub_category_id == $value->id): ?>
                                                                selected
                                                            <?php endif; ?>
                                                        <?php endif; ?>>
                                    ...
                                    <div class="col-md-6">
                                       <div class="row no-gutters input-right-icon mt-20">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input
                                                        ...
                                                        id="startDate" type="text" placeholder="<?php echo app('translator')->get('lang.date'); ?> *"
                                                        name="date"
                                                        value="<?php echo e(!empty($add_news)? date('m/d/Y', strtotime($add_news->publish_date)): date('m/d/Y')); ?>">
                                                    <span class="focus-border"></span>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            <input class="primary-input" type="text" id="placeholderFileOneName"
                                                                   placeholder="<?php echo e(!empty($add_news)? ($add_news->image !="") ? showPicName($add_news->image) :'image' :'image'); ?>"
                                                                   readonly
                                                            >
                                                            <span class="focus-border"></span>
                                                        </div>
                                        ...
                                        <div class="row mt-25">
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                            <textarea class="primary-input form-control" cols="0" rows="4" id="a" 
                                                      name="description"><?php echo e(!empty($add_news)? $add_news->description: old('news_body')); ?></textarea>
                                ...
                                <div class="row mt-25">
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                            <textarea class="primary-input form-control" cols="0" rows="4" id="summernote" 
                                                      name="news_body"><?php echo e(!empty($add_news)? $add_news->news_body: old('news_body')); ?></textarea>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($value->sub_category_id !=""?$value->subcategory->sub_category_name:""); ?></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(url('edit-news/'.$value->id)); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#category').change(function(e){
            ...
            $.get('/sub-categories/'+id,function(data){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\SGSS\resources\views/backEnd/news/news_page.blade.php ENDPATH**/ ?>