            ...
            <div class="container box-1420">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item <?php echo e(Request::path() == 'contact'? 'active':''); ?>"><a class="nav-link"
                                                                                              href="<?php echo e(url('/')); ?>/admissions">Admissions</a>
                        </li>
                        <li class="nav-item <?php echo e(Request::path() == 'enrolment'? 'active':''); ?>"><a class="nav-link"
                                                                                              href="<?php echo e(url('/')); ?>/enrolment">Enrolment</a>
                        </li>
                        <li class="nav-item">
                            <a href="#"  class="nav-link"  data-toggle="modal" data-target="#booktour" data-whatever="@mdo">Book a tour</a>
                        </li>
...
<script type="text/javascript">
        ...
        $('.btn-booktour').click(function(){
            var dial_code = $("#telephone2").intlTelInput("getSelectedCountryData").dialCode;
            var country = $("#telephone2").intlTelInput("getSelectedCountryData").name;
            $('#dial2').val(dial_code);
            $('#country2').val(country);
        });

        $('.save_complaint').click(function(){
            var dial_code = $("#telephone1").intlTelInput("getSelectedCountryData").dialCode;
            var country = $("#telephone1").intlTelInput("getSelectedCountryData").name;
            $('#dial1').val(dial_code);
...
<?php /**PATH D:\SERVER\www\SGSS\resources\views/frontEnd/home/front_master.blade.php ENDPATH**/ ?>