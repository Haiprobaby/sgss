	       ...
	       <div class="card-body">		
			...
			<table class="table table-bordered">
			  ...
			  <tbody>
			  	...
			  	<?php $__currentLoopData = $early->years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $years): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			    <tr>
			...
			<table class="table table-bordered">
			  ...
			  <tbody>
			  	...
			  	<?php $__currentLoopData = $early->fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fees): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			    <tr >
      ...
      <div class="card-body">
		...
		<table class="table table-bordered">
		  ...
		  <tbody>
		  	...
		  	<?php $__currentLoopData = $primary->years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $years): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		    <tr>
		       	  <th scope="row"><?php echo e($years->title); ?></th>
			      <td><?php echo e(number_format($years->tuition_payment_A)); ?></td>
			      <td><?php echo e(number_format($years->tuition_payment_B1)); ?></td>
		...
		<h4>Other Fees</h4>
			<table class="table table-bordered">
			  ...
			  <tbody>
			  	...
			  	<?php $__currentLoopData = $primary->fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fees): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			    <tr >
			      <th scope="row"><?php echo e($fees->Name); ?></th>
			      <td><?php echo e($fees->description); ?></td>
			      <td><?php echo e(number_format($fees->price)); ?></td>
      ...
      <div class="card-body">
		...
		<table class="table table-bordered">
		  ...
		  <tbody>
		  	...
		  	<?php $__currentLoopData = $middle->years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $years): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		    <tr>
		          <th scope="row"><?php echo e($years->title); ?></th>
			      <td><?php echo e(number_format($years->tuition_payment_A)); ?></td>
			      <td><?php echo e(number_format($years->tuition_payment_B1)); ?></td>
		...
		<h4>Other Fees</h4>
			<table class="table table-bordered">
			  ...
			  <tbody>
			  	...
			  	<?php $__currentLoopData = $middle->fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fees): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			    <tr >
			      <th scope="row"><?php echo e($fees->Name); ?></th>
			      <td><?php echo e($fees->description); ?></td>
			      <td><?php echo e(number_format($fees->price)); ?></td>
...
<?php echo $__env->make('frontEnd.home.layout.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\sgss\t\sgss\resources\views/frontEnd/home/admissions.blade.php ENDPATH**/ ?>