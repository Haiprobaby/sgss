                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('lang.student_list'); ?> (<?php echo e(@$students->count()); ?>)</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr id="<?php echo e(@$value->user_id); ?>">
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php if(in_array(@$permission_id, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
                                    <label class="switch">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\SGSS\resources\views/backEnd/systemSettings/login_access_control.blade.php ENDPATH**/ ?>