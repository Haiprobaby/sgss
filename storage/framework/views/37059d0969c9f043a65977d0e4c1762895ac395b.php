    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('assign_subject_create')); ?>"><?php echo app('translator')->get('lang.assign_optional_subject'); ?></a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\SGSS\resources\views/backEnd/systemSettings/optional_subject_setup.blade.php ENDPATH**/ ?>