...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.add_expense'); ?> </h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?> </a>
                <a href="#"><?php echo app('translator')->get('lang.accounts'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.add_expense'); ?></a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="main-title">
                            ...
                            <h3 class="mb-30">
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->get('lang.add'); ?>
                                <?php endif; ?>
                                <?php echo app('translator')->get('lang.expense'); ?>
                            </h3>
                        </div>
                        <?php if(isset($add_expense)): ?>
                                    ...
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input date form-control<?php echo e(@$errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text"
                                                placeholder="<?php echo app('translator')->get('lang.date'); ?> " name="date" value="<?php echo e(isset($add_expense)? date('m/d/Y',strtotime($add_expense->date)) : date('m/d/Y')); ?>">
                                            <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('lang.expense'); ?>  <?php echo app('translator')->get('lang.list'); ?> </h3>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-sort="<?php echo e(strtotime(@$add_expense->date)); ?>">
                                        <?php echo e(@$add_expense->date != ""? App\SmGeneralSettings::DateConvater(@$add_expense->date):''); ?></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(url('add-expense', [@$add_expense->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?> </a>
                                                <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PC\Desktop\sgss\t\sgss\resources\views/backEnd/accounts/add_expense.blade.php ENDPATH**/ ?>