                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e(@$errors->has('receivingfor') ? ' is-invalid' : ''); ?>"
                                                type="text" name="receivingfor" value="<?php echo e(isset($add_income)? $add_income->receivingfor: old('receivingfor')); ?>" maxlength="100">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\www\SGSS\resources\views/backEnd/accounts/add_income.blade.php ENDPATH**/ ?>