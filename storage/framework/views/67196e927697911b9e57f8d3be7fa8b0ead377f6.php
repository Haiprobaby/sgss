  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add-discount" method="POST" >
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="1styear_add" maxlength="3">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Second year:</label>
            <input type="text" class="form-control" id="2ndyear_add" maxlength="3">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Third year:</label>
            <input type="text" class="form-control" id="3rdyear_add" maxlength="3">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Fourth year:</label>
            <input type="text" class="form-control" id="4thyear_add" maxlength="3">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Fifth year+:</label>
            <input type="text" class="form-control" id="5thyear_add" maxlength="3">
          </div>
...
</div><?php /**PATH C:\wamp64\www\SGSS\resources\views/backEnd/feesCollection/fee_policies/modals/add_discount.blade.php ENDPATH**/ ?>