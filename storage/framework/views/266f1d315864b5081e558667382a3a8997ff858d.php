    ...
    <section class="admin-visitor-area up_admin_visitor empty_table_tab">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-2 text-right col-md-12">
                <a href="<?php echo e(url('database-upgrade')); ?>" class="primary-btn small fix-gr-bg">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->get('lang.update'); ?> <?php echo app('translator')->get('lang.details'); ?></h3>
                            </div>
                            <div class="white-box">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WWW\SGSS\resources\views/backEnd/systemSettings/updateSettings.blade.php ENDPATH**/ ?>