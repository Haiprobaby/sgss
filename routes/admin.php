...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('staff-download-timeline-doc/{file_name}', function ($file_name = null) {
         ...
         /* ******************* Categories Images ***************************** */
         Route::get('admin-category', 'SmCategoriesImagesController@index');
         Route::post('admin-category', 'SmCategoriesImagesController@upload');
         Route::delete('admin-category', 'SmCategoriesImagesController@delete');
         Route::post('admin-category/display', 'SmCategoriesImagesController@display'); // set display category
        ...
        // income head routes
        Route::resource('income', 'SmAddIncomeController');  
        Route::get('print-Income/{id}', ['as' => 'income_print', 'uses' => 'SmAddIncomeController@printIncome']);
        ...
        Route::get('get-student-info/{id}','SmAddIncomeController@studentInfo');
        Route::get('get-payer-name/{id_student}/{id_pay}','SmAddIncomeController@payerName');
 ...
 Route::post('test-career', ['as' => 'test_career', 'uses' => 'CareerController@test']);
 Route::get('careers-list','CareerController@index');
 Route::post('career-store', ['as' => 'career_store', 'uses' => 'CareerController@store']);
 Route::get('career-edit/{id}', ['as' => 'career_edit', 'uses' => 'CareerController@edit']);
 Route::post('career-update', ['as' => 'career_update', 'uses' => 'CareerController@update']);
 Route::get('career-delete/{id}', ['as' => 'career_delete', 'uses' => 'CareerController@delete']);
 
Route::get('files','haisController@files');
Route::post('files-add','haisController@fileAdd');
Route::get('files-edit/{id}','haisController@fileEdit');
Route::post('files-update','haisController@fileUpdate');
Route::get('for-delete-file/{id}','haisController@forDeleteFile');
Route::get('filedelete/{id}','haisController@fileDelete');
/* ******************* END Career routes start ***************************** */