...
Route::get('sendmail', function () {
    return Zoom::user()->where('status', 'active')->get()->toArray();
    // $data[] = 'dcfs';
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('institution-privacy-policy', 'SmFrontendController@institutionPrivacyPolicy');
    Route::get('institution-terms-service', 'SmFrontendController@institutionTermServices');
    ...
    Route::get('life-school',  'SmFrontendController@lifeSchool');
    Route::get('life-school/{id}',  'SmFrontendController@lifeSchoolDetail');
    Route::get('historys',  'SmFrontendController@historys');
    Route::get('teachers',  'SmFrontendController@teachers');

    Route::get('db-upgrade',  'SmSystemSettingController@DbUpgrade');
    ...
    Route::get('contact', 'SmFrontendController@contact');
     /* ::::::::::::::::::::::::: START POST PAGE ROUTES :::::::::::::::::::::::::: */
     Route::get('post/{id}',  'SmFrontendController@renderCatePost');
     /* ::::::::::::::::::::::::: END POST PAGE SEARCH ROUTES :::::::::::::::::::::::::: */

      /* :::::::::::::::::::::::::  enrolment form :::::::::::::::::::::::::: */
     Route::get('enrolment', 'SmFrontendController@enrolment_index');

     Route::get('enrolment/step_1', 'SmFrontendController@enrolment_1');
     Route::post('enrolment/step_1', 'SmFrontendController@enrolment_1s');

     Route::get('enrolment/step_2', 'SmFrontendController@enrolment_2');
     Route::post('enrolment/step_2', 'SmFrontendController@enrolment_2s');

     Route::get('enrolment/step_3', 'SmFrontendController@enrolment_3');
     Route::post('enrolment/step_3', 'SmFrontendController@enrolment_3s');

     Route::get('enrolment/finished', 'SmFrontendController@enrolment_finished');
     Route::get('category', 'SmFrontendController@category'); // categories-images
      /* :::::::::::::::::::::::::   end enrolment form :::::::::::::::::::::::::: */
    ...
    Route::get('moduleAddOnsEnable/{name}', 'SmAddOnsController@moduleAddOnsEnable');
    ...
    Route::get('notification-show/{id}', 'SmNotificationController@udpateNotification');
    ...
    Route::get('system-config', 'InstallController@verify')->name('system.config');
    Route::get('Moduleverify/{name}', 'InstallController@Moduleverify')->name('Moduleverify');
    ...
    Route::get('system-destroyed-by-authorized', 'SmSystemSettingController@systemDestroyedByAuthorized')->name('systemDestroyedByAuthorized');
     //Fee policies //Phạm Trọng Hải
     Route::get('edit-fees/{id}','feesController@editfees');
     Route::post('updatefees','feesController@updatefees')->name('middleyear-fees');

     Route::get('list-fees-group','feesController@getlist')->name('list-group');
     ///Phạm Trọng Hải

     // Add/Edit/delete discount routes
     Route::post('edit-discount','AjaxController@editdiscount');

     Route::post('add-discount','AjaxController@adddiscount');

     Route::get('delete-discount/{id}','AjaxController@deletediscount');
     //Phạm Trọng HẢI
     ///grades
     Route::get('add-grade',function(){
         return view('add_grade_demo');
     });
     Route::post('add-grade','feesController@addgrade')->name('add-grade');

     Route::get('delete-grade/{id}','feesController@deletegrade')->name('delete-grade');

     // grades
     // Late enrol routes
     Route::post('edit-enrol','AjaxController@editlateenrol')->name('edit-enrol');
     //Late enrol routes
     // withdraw routes
     Route::post('edit-withdraw','AjaxController@editwithdraw')->name('edit-withdraw');
     //withdraw routes

     //Pham Trọng Hải //Route show admissions
     Route::get('admissions','SmFrontendController@admissions');
     
     //Pham Trọng Hải //Route show admissions
     //Pham Trọng Hải //Route store book tour
     Route::post('book-tour','SmVisitorController@store');
     //Pham Trọng Hải //Route store book tour
     //Pham Trọng Hải //Route store complaint
     Route::post('add-complaint','SmComplaintController@store');
     //Pham Trọng Hải //Route store complaint
});
/*Phạm Trọng Hải // 29/07/2020  Carreer, news sub-category start*/
Route::get('category/{id}','SmFrontendController@subcate');
Route::get('category-items/{id}','SmFrontendController@category_items');
 Route::get('view-item/{id}','SmFrontendController@viewitem');
 
 
 Route::get('careers','SmFrontendController@careers');
 Route::get('view-career/{id}','SmFrontendController@viewcareer');
 Route::post('apply','SmFrontendController@job_apply');
 Route::get('news-sub-category', 'SmNewsController@newsSubCategory');
 Route::post('/sub-category-store', 'SmNewsController@storeSubCategory')->name('store_Sub_category');
 Route::post('/sub-category-update', 'SmNewsController@updateSubCategory')->name('update_Sub_category');
 Route::get('for-delete-sub-category/{id}', 'SmNewsController@forDeleteSubCategory');
 Route::get('delete-sub-category/{id}', 'SmNewsController@deleteSubCategory');
 Route::get('edit-sub-category/{id}', 'SmNewsController@editSubCategory');

 Route::get('sub-categories/{id}','SmFrontendController@getlistsubcate');
 Route::get('get-category/{id}','SmFrontendController@getcategory');
 ...
 Route::get('parents','haisController@parentsessentials');
 Route::get('by-category/{id}','haisController@news_by_cate');
 Route::get('by-subcategory/{id}','haisController@by_sub_cate');

 /*Phạm Trọng Hải // 29/07/2020  news sub-category end*/
 //************** */ Cao Văn Anh 13-08-2020 ***************//
Route::get('course-heading-update', 'SmFrontendController@courseHeading');
Route::post('course-heading-update', 'SmFrontendController@courseHeadingUpdate');   