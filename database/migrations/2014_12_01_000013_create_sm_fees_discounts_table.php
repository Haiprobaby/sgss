...
class CreateSmFeesDiscountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sm_fees_discounts', function (Blueprint $table) {
            ...
            $table->varchar('first_year')->nullable();
            $table->varchar('second_year')->nullable();
            $table->varchar('third_year')->nullable();
            $table->varchar('fourth_year')->nullable();
            $table->varchar('first_fifth_and_subsequent_yearsyear')->nullable();
